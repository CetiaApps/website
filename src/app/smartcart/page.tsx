...
const carouselScreenshots = [
  { screen: 2, alt: 'SmartCart shopping lists screen', className: 'z-10 hidden translate-x-12 scale-75 rotate-[-13deg] opacity-70 md:block' },
  { screen: 3, alt: 'SmartCart grocery list with realtime prices', className: 'z-20 hidden translate-x-6 scale-90 rotate-[-7deg] opacity-90 sm:block' },
  { screen: 4, alt: 'SmartCart product price comparison screen', className: 'z-30 scale-95 md:scale-100' },
  { screen: 5, alt: 'SmartCart nearest supermarkets screen', className: 'z-20 hidden -translate-x-6 scale-90 rotate-[7deg] opacity-90 sm:block' },
  { screen: 7, alt: 'SmartCart plans screen', className: 'z-10 hidden -translate-x-12 scale-75 rotate-[13deg] opacity-70 md:block' },
];
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 pb-16 md:grid-cols-[0.95fr_1.05fr] md:px-10 md:pb-24">
            <div>
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                ...
                <Link href="/" className="inline-flex min-h-[48px] items-center justify-center rounded-full border border-border bg-card px-6 text-sm font-extrabold text-foreground">
          ...
          <div className="mx-auto max-w-7xl px-5 md:px-10">
            ...
            <div className="relative mx-auto flex min-h-[580px] max-w-6xl items-center justify-center overflow-hidden rounded-[2rem] border border-border bg-card px-4 py-10 shadow-2xl shadow-teal-900/10 [perspective:1400px]">
              ...
              <div className="relative flex w-full items-center justify-center -space-x-16 sm:-space-x-20 md:-space-x-24">
                {carouselScreenshots.map(({ screen, alt, className }) => (
                  <div
                    key={screen}
          ...
          <div className="mx-auto max-w-7xl px-5 md:px-10">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {benefits.map((benefit) => (
                <div key={benefit} className="rounded-2xl border border-border bg-card p-5 shadow-sm">
        ...
        <section className="bg-card py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-5 md:px-10">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              {faqs.map((faq) => (
                <div key={faq.question} className="rounded-2xl border border-border bg-background p-6 shadow-sm">
