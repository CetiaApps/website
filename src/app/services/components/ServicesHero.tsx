        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-10">
              From concept to App Store in 8–12 weeks. CetiaApps delivers end-to-end mobile app development for startups and established businesses ready to go mobile.
            </p>
